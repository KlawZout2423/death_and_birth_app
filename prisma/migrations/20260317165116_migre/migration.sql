...
*/
-- DropForeignKey
ALTER TABLE "Certificate" DROP CONSTRAINT "Certificate_issuedById_fkey";

-- DropForeignKey
ALTER TABLE "DeathRecord" DROP CONSTRAINT "DeathRecord_createdById_fkey";

-- DropForeignKey
ALTER TABLE "DeathRecord" DROP CONSTRAINT "DeathRecord_verifiedById_fkey";

-- DropForeignKey
ALTER TABLE "Notification" DROP CONSTRAINT "Notification_viewedById_fkey";
