  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-600 dark:text-zinc-400">Review death-record notifications sent to insurance institutions.</p>
      </div>
                ...
                <tr key={item.id} className="border-t border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700">
                  ...
                  <td className="px-6 py-4 text-sm">
                    <div className="flex flex-wrap gap-2">
                      ...
                      <a
                        href={`/insurance/next-of-kin?deathRecordId=${encodeURIComponent(item.deathRecordId)}`}
                        className="rounded-lg border border-sky-200 bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-800 transition hover:bg-sky-100 dark:border-sky-800 dark:bg-sky-900/20 dark:text-sky-100 dark:hover:bg-sky-900/30"
                      >
                        Next of kin
                      </a>
                      <button
