...
export default function SSNITNotificationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-600 dark:text-zinc-400">Review death-record notifications sent to pension institutions.</p>
      </div>
                ...
                <tr key={item.id} className="border-t border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700">
                  ...
                  <td className="px-6 py-4 text-sm">
                    <div className="flex flex-wrap gap-2">
                      ...
                      <a
                        href={`/ssnit/next-of-kin?deathRecordId=${encodeURIComponent(item.deathRecordId)}`}
                        className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-900 transition hover:bg-amber-100 dark:border-amber-800 dark:bg-amber-900/20 dark:text-amber-100 dark:hover:bg-amber-900/30"
                      >
                        Next of kin
                      </a>
                      <button
